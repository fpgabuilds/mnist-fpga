...
- input_buffer_bram: dual_port_bram
- load_buf_to_mem_wgts_inst: sr_ff
- load_wgts_to_mem_inst: sr_ff
- conv_weight_mem_shift_inst: shift_reg_with_store
- simple_counter_inst_a: simple_counter
- conv_need_data_singlefire: d_delay
- conv_layer_inst: convolution_layer
- conv_save_mem_delay_inst: sr_ff
